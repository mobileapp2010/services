...
/**
 * @api
 * @package services\core\env\
 * @source 5  
 * @author Arnold Sameroff
 * @email ast@mobileappz.in 
 * @timestamp March/14/2014 10:01AM
 * @copyright nosave
 * @version 1.0
 * @class env
 * This is DB class which will communicate with storage engine to full fill all requets 
 */
final class env
{
...
$columnNameToUpdate=array(
    ...
    "f_country" => "country",
    "f_company" => "nosave",
    "f_companyDiscription" => "nosave PVT. LTD.",
    "f_companyAddress" => "address",
    "f_companyPhone" => 12121212,
    "f_companyFax" => 12121212,
    "f_companyCity" => "citry",
    "f_compayCountry" => "country",
    "f_websiteUrl" => "http://www.nosave.com",
    "f_phone" => 12121212,
